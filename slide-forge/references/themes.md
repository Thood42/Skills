# Theme gallery — 11 drop-in palettes
...
## 11 · Ember Red  (dark · bold/automotive)
High-energy red→orange→amber on near-black. Good for performance, engineering, motorsport, "powerful" brands. (Discovered from a Databricks-for-Automotive deck and folded in as a reusable palette.)
```html
<link href="https://fonts.googleapis.com/css2?family=Exo+2:wght@500;600;700;800&family=IBM+Plex+Sans:wght@400;500;600&family=JetBrains+Mono:wght@400;500;700&display=swap" rel="stylesheet">
```
```css
:root{
  --bg:#0d0404; --bg-2:#1a0707;
  --ink:#fff0ee; --muted:#c49090; --faint:#7a5050;
  --cyan:#ff2d2d; --indigo:#ff6d00; --mint:#ffb300;
  --panel:rgba(255,60,40,.045); --panel-2:rgba(255,80,40,.065);
  --brd:rgba(255,60,40,.18); --brd-2:rgba(255,80,40,.38); --grid:rgba(255,60,40,.10);
  --glow-cyan:0 0 34px rgba(255,45,45,.48); --stage:#080202; --dot:rgba(255,60,40,.10);
  --font-display:'Exo 2','DejaVu Sans',system-ui,sans-serif;
  --font-body:'IBM Plex Sans','DejaVu Sans',system-ui,sans-serif;
  --font-mono:'JetBrains Mono','DejaVu Sans Mono',ui-monospace,monospace;
  --pad:70px 88px;
}
